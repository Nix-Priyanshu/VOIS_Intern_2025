...
# Clear old model if hyperparameters change
# Reset model ONLY when hyperparameters change
if 'last_n_estimators' not in st.session_state:
    st.session_state.last_n_estimators = n_estimators

if st.session_state.last_n_estimators != n_estimators:
...
with col_train:
    ...
    if 'model' in st.session_state:
        ...
        # --- Feature Importance ---
        model = st.session_state['model']  # safe retrieval
...
p_pkts = c2.number_input("Total Packets", 0, 2000, 100) 
